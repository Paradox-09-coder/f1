    ...
    <div>
        <div className="video-box">
            ...
            <div className="wrapper-for-video">
               ...
               <div className="video-cards">
                <video className='kichkina-video' muted loop controls autoPlay src="/icon/video7.mp4"></video>
                <p className="video-text">
               ...
               <div className="video-cards">
                <video className='kichkina-video' muted loop controls autoPlay src="/icon/video6.mp4"></video>
                <p className="video-text">
               ...
               <div className="video-cards">
                <video className='kichkina-video' muted loop controls autoPlay src="/icon/video8.mp4"></video>
                <p className="video-text">
